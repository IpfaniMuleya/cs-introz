        ...
        <div className="container mx-auto px-4 py-8">
            <div className="container mx-auto px-4 flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <p className="mb-4">
                            We'd love to hear from you! Whether you have questions about our courses, need technical
                            support, or simply want to share your feedback, our team is here to assist.
                        </p>
